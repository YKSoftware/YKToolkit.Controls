namespace YKToolkit.Sample.ViewModels
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        public DelegateCommand ChageThemeCommand
        {
            get
            {
                return _changeThemeCommand ?? (_changeThemeCommand = new DelegateCommand(_ =>
                {
                    ...
                    var index = manager.ThemeNameList.IndexOf(manager.CurrentTheme) + 1;
                    if (index >= manager.ThemeNameList.Count)
                        index = 0;
                    ...
                    _viewModels = new ReadOnlyCollection<ViewModelInfo>(new List<ViewModelInfo>()
                    {
                        ...
                        new ViewModelInfo()
                        {
                            ...
                            Children = new List<ViewModelInfo>()
                            {
                                ...
                                new ViewModelInfo() { Name = "Messenger", Instance = this._messengerViewModel, },
        ...
        private MessengerViewModel _messengerViewModel = new MessengerViewModel();
